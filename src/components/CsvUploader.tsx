    ...
    <div className="p-4">
      ...
      <div className="mt-12 text-center">
        <a
          ...
          style={{ display:"inline-flex", alignItems:"center", gap:"0.5rem", padding:"0.6rem 1.4rem", borderRadius:6, border:"1px solid rgba(91,184,232,0.5)", background:"rgba(91,184,232,0.08)", color:"#5BB8E8", fontWeight:500, fontSize:"0.9rem", textDecoration:"none", transition:"all 0.2s" }} onMouseEnter={e=>{e.currentTarget.style.background="rgba(91,184,232,0.18)";e.currentTarget.style.borderColor="#5BB8E8"}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(91,184,232,0.08)";e.currentTarget.style.borderColor="rgba(91,184,232,0.5)"}}
        >
